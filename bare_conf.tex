...
Originally invented for computer version\cite{lecun1995convolutional}, CNN models have subsequently been shown to be effective for many different problems including, Simultaneous Localization and Mapping(SLAM)\cite{naseer2015robust}, Decision Making\cite{giusti2016machine} and Automatic Driving\cite{bojarski2016end}.  \\
